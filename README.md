...
- `SUPABASE_URL`
- `SUPABASE_SERVICE_ROLE_KEY` (**recommended for backend server usage**)
...
> If registration fails with permission/RLS errors, use `SUPABASE_SERVICE_ROLE_KEY` in your backend `.env`.
